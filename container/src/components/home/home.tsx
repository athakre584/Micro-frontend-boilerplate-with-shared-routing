    ...
    <div>
      <div className={styles.page_header}>
        <header>
          <div>
            <nav
              className={`${globalStyles.navbar} ${globalStyles['navbar-expand-sm']} custom-navbar`}
            >
              <div className={`${globalStyles.container}`}>
                ...
                >
                  <ul
                    className={`${globalStyles['navbar-nav']} ${globalStyles['ml-auto']}`}
                  >
      ...
      <div className={styles.landing_page}>
        ...
        <div className={styles.arch}>
          <div
            className={`${globalStyles.card} ${globalStyles['bg-dark']} text-white`}
          >
            <img
              src={architectureImage}
              className={`${globalStyles['card-img']}`}
              alt="..."
            />
            <div className={`${globalStyles['card-img-overlay']}`}>
              <h5 className={`${globalStyles['card-title']}`}>
