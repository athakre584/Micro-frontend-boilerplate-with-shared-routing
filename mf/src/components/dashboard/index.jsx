  ...
  return (
    <div>
      <nav>
        ...
        <ul>
          <li>
            <a className={`${globalStyles['nav-link']}`} href="#hero-section">
              Home
            </a>
          </li>
          <li>
            <a className={`${globalStyles['nav-link']}`} href="#about-us">
              About
            </a>
          </li>
          <li>
            <a className={`${globalStyles['nav-link']}`} href="#contact">
              Contact
            </a>
          </li>
        </ul>
      ...
      <div className={styles.landing_page}>
        <div className={styles.banner_section}>
          <div className={styles.banner_text}>
            ...
            <p>
              <strong>Container Application</strong>
            </p>
          ...
          <div className={`${globalStyles['row']}`}>
            ...
            <div className={`${globalStyles['col-md-4']}`}>
              <div className={styles.cards_item}>
                <div className={styles.card}>
                  <div className={styles.card_image}>
                    <img src={mfImage} alt="mfe-benefits" />
                  </div>
                  <div className={styles.card_content}>
            ...
            <div className={`${globalStyles['col-md-4']}`}>
              <div className={styles.cards_item}>
                <div className={styles.card}>
                  <div className={styles.card_image}>
                    <img src={mfImage} alt="mfe-ways" />
                  </div>
                  <div className={styles.card_content}>
                    <h2 className={styles.card_title}>
                      Ways to implement Microfrontend
                    </h2>
                    <p className={styles.card_text}>
                      Demo of pixel perfect pure CSS simple responsive card grid
                      layout
            ...
            <div className={`${globalStyles['col-md-4']}`}>
              <div className={styles.cards_item}>
                <div className={styles.card}>
                  <div className={styles.card_image}>
                    <img src={mfImage} alt="mfe-architecure" />
                  </div>
                  <div className={styles.card_content}>
        ...
        <div className={styles.section_primary}>
          <div className={styles.three_point_section}>
            ...
            <div className={styles.features}>
              ...
              <p>
                This is why its great. Heres the one thing you should know about the
                microfrontend.
              </p>
            </div>
            <div className={styles.features}>
