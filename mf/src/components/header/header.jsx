...
const Header = () => {
  return (
    <header>
      <nav
        className={`${styles.nav_bar} ${globalStyles['navbar']} ${globalStyles['navbar-expand-sm']} ${globalStyles['custom-navbar']} `}
      >
        <div className={`${globalStyles['container']}`}>
          ...
          >
            <ul
              className={`${styles.navbar_nav} ${globalStyles['navbar-nav']} ${globalStyles['ml-auto']}`}
            >
              <li className={`${styles.nav_item} ${globalStyles['nav-item']} `}>
                <Link
                  className={`${styles.nav_link} ${globalStyles['nav-link']} `}
                  to="/home"
                >
                  {'Home'}
                </Link>
